var firebug = {
        ...
        inspector:{
            ...
            inspect:function(_element,_bgInspector){
                with(firebug){
                    ...
                    if (firebug.env.isPopup) {
                      pos = window.opener.firebug.lib.util.Element.getPosition(_element);
                    } else {
                      pos = firebug.lib.util.Element.getPosition(_element);
                    }
    ...
    getDomain:function(_url){
        var match = _url.match(/http:\/\/(www.)?([\.\w-_]+)/);
